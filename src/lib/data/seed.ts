...
export const COMPANIES: Record<string, Company> = {
  stripe: { id: 'stripe', name: 'Stripe', bg: '#635BFF', initial: 'S', domain: 'stripe.com' },
  airbnb: { id: 'airbnb', name: 'Airbnb', bg: '#FF5A5F', initial: 'A', domain: 'airbnb.com' },
  figma: { id: 'figma', name: 'Figma', bg: '#0ACF83', initial: 'F', domain: 'figma.com' },
  linear: { id: 'linear', name: 'Linear', bg: '#5E6AD2', initial: 'L', domain: 'linear.app' },
  vercel: {
    id: 'vercel',
    name: 'Vercel',
    bg: '#0A0A0B',
  ...
  openai: { id: 'openai', name: 'OpenAI', bg: '#10A37F', initial: 'O', domain: 'openai.com' },
  databricks: {
    id: 'databricks',
    name: 'Databricks',
    bg: '#FF3621',
  ...
  brex: { id: 'brex', name: 'Brex', bg: '#2563EB', initial: 'B', domain: 'brex.com' },
  retool: {
    id: 'retool',
    name: 'Retool',
    bg: '#F97316',
...
export const RESUMES: Resume[] = [
  {
    ...audited('resume-nikhil-2026', 0),
    name: 'Nikhil Netraganti Resume 2026',
    flavor: 'Senior Java/Spring backend, healthcare systems, and platform roles.',
    ...
    summary:
      'Senior Software Engineer with Java/Spring microservices, healthcare eligibility systems, React modernization, Kafka/AWS pipelines, and production ownership.',
    timesUsed: 0,
  },
  {
...
export const PROFILE: Profile = {
  ...
  name: 'Nikhil Netraganti',
  handle: '@nikhil-netraganti',
  email: 'nikhil_netra@hotmail.com',
  phone: '972 740 9551',
  location: 'Santa Clara, CA',
  pronouns: '',
  headline: 'Senior Software Engineer - Java, Spring Boot, healthcare systems, and cloud platforms',
  about:
    'Senior Software Engineer with 6+ years building Java/Spring services, healthcare eligibility and enrollment systems, React modernization work, and cloud-backed data pipelines. Experienced across REST microservices, SQL, Kafka, AWS, Docker/Kubernetes, Redis, CI/CD, and production defect ownership.\n\nLooking for senior backend or platform roles where Java/Spring depth, system design, API ownership, and pragmatic delivery matter.',
  links: [{ label: 'LinkedIn', url: 'www.linkedin.com/in/nikhil-netraganti', icon: 'link' }],
  openToWork: true,
  preferences: {
    roles: ['Senior Java Engineer', 'Senior Software Engineer', 'Backend Engineer'],
    remote: ['Hybrid (Bay Area)', 'Remote'],
    minComp: 160,
    industries: [
    ...
    avoid: ['Unpaid contract', 'Junior-only roles'],
    notice: '2-4 weeks',
  },
  experience: [
    {
      ...
      bullets: [
        'Architected secure REST microservices in Java, Spring, Docker, and Kubernetes for healthcare and demographic vendor integrations.',
        'Modernized a 300+ screen JSP/Oracle platform into a React, Redux, PostgreSQL, and AWS stack.',
        'Built Kafka/AWS feedback pipelines and internal AI-assisted code review tooling to reduce detection and review turnaround time.',
        'Owned defect resolution and production triage across Medicare/Medicaid eligibility, enrollment, and benefit issuance modules.',
      ],
    },
    {
      id: 'exp2',
      ...
      bullets: [
        'Developed Java/Spring Boot web UI and backend features for SNAP eligibility triage workflows.',
        'Partnered with analysts and managers to prioritize framework development for critical application requirements.',
        'Resolved legacy code defects with the Indiana Medicaid state division, reducing pending code issues.',
      ],
    },
    {
      id: 'exp3',
      ...
      location: 'Tempe, AZ',
      bullets: [
        'Redesigned and developed the department website using React, JavaScript, and HTML.',
        'Refactored a legacy Java/Spring backend serving GIS data and improved API response times.',
      ],
    },
  ],
  education: [
  ...
  skills: [
    { name: 'Java', level: 5, years: 6, endorsements: 0 },
    { name: 'Spring Boot', level: 5, years: 6, endorsements: 0 },
    { name: 'REST Microservices', level: 5, years: 6, endorsements: 0 },
    { name: 'SQL', level: 5, years: 6, endorsements: 0 },
    { name: 'Kafka', level: 4, years: 3, endorsements: 0 },
    { name: 'React', level: 4, years: 5, endorsements: 0 },
    { name: 'AWS', level: 4, years: 4, endorsements: 0 },
    { name: 'Docker', level: 4, years: 4, endorsements: 0 },
    { name: 'Kubernetes', level: 4, years: 4, endorsements: 0 },
    { name: 'JUnit', level: 4, years: 5, endorsements: 0 },
    { name: 'Mockito', level: 4, years: 5, endorsements: 0 },
    { name: 'Redis', level: 3, years: 2, endorsements: 0 },
  ],
  languages: [{ name: 'English', level: 'Native' }],
  certifications: [],
  achievements: [
    'Reduced manual code review turnaround by 48% with a multi-agent Python/Claude review system.',
    'Reduced bug time-to-detection by 29% with Bedrock, Kafka, and third-party ticketing integrations.',
    'Reduced correspondence defects by 30% across OpenText document-generation workflows.',
    'Built AEM-aligned Merchant Offer Hub project with Sling, JCR/Oak, OSGi, Docker, Nginx, and JUnit coverage.',
  ],
  completeness: {
    sections: [
